...
- Agrees to provide an accurate list of all local contributors and their [ORCID iDs](https://orcid.org/) to the project team. This list will be included in dataset release metadata to ensure proper attribution.
...
All data contributed to this project is released to the public under the **[Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/)** license.
